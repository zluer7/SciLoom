...
export interface ReviewSaveAsPresentationDependencies {
  presentation: typeof manuscriptSaveAsPresentationProtocol;
  nextGeneration(): number;
}

const defaultDependencies: ReviewSaveAsPresentationDependencies = {
...
export function createReviewManuscriptSaveAsPresentationAdapter(
  dependencies: ReviewSaveAsPresentationDependencies = defaultDependencies
) {
...
export const reviewManuscriptSaveAsPresentationAdapter =
