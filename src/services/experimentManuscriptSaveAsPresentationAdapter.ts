...
export interface ExperimentSaveAsPresentationDependencies {
  presentation: typeof manuscriptSaveAsPresentationProtocol;
  nextGeneration(): number;
}

const defaultDependencies: ExperimentSaveAsPresentationDependencies = {
...
export function createExperimentManuscriptSaveAsPresentationAdapter(
  dependencies: ExperimentSaveAsPresentationDependencies = defaultDependencies
) {
...
export const experimentManuscriptSaveAsPresentationAdapter =
  createExperimentManuscriptSaveAsPresentationAdapter();
